...
class Admin extends Controller{
    ...
    public function promotionStore() {
        ...
        $name = trim($_POST['name'] ?? '') ?: $code; // Nếu không có name thì dùng code
        ...
        $promotionModel = $this->model('PromotionModel');
        $sql = "INSERT INTO promotions (code,name,type,value,min_order_amount,start_date,end_date,status,usage_limit,created_at) VALUES (:code,:name,:type,:value,:min_order_amount,:start_date,:end_date,:status,:usage_limit,NOW())";
    ...
    public function promotionUpdate($id) {
        ...
        $name = trim($_POST['name'] ?? '') ?: $_POST['code'];
        $sql = "UPDATE promotions SET code=:code,name=:name,type=:type,value=:value,min_order_amount=:min_order_amount,start_date=:start_date,end_date=:end_date,status=:status,usage_limit=:usage_limit WHERE id=:id";
    ...
    public function reviewList() {
        ...
        // Debug: test trực tiếp
        // Uncomment dòng dưới để debug
        // echo "<pre>"; print_r($reviewModel->getAllReviews()); die();
