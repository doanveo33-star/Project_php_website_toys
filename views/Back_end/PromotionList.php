            ...
            <tbody>
                <?php if (!empty($promotions)): $i = 1; ?>
                    ...
                    <tr>
                        ...
                        <td><?= htmlspecialchars($promo['name'] ?? $promo['code'] ?? '') ?></td>
                        <td>
                            <?php if ($type == 'percent'): ?>
                        ...
                        <td style="font-size:13px;">
                            <?= !empty($promo['start_date']) ? date('d/m/Y', strtotime($promo['start_date'])) : 'N/A' ?>
                            <br>
                            <?= !empty($promo['end_date']) ? date('d/m/Y', strtotime($promo['end_date'])) : 'N/A' ?>
                        </td>
